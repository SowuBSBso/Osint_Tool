...
try:
    ...
    print(f'Modules of the python library required for UrumaDevice are not installed, make sure you have correctly installed python and have launched the "Setup.py" file which will install all the necessary modules.')
    input(f'Error: {e}')

color_webhook = 0xa80505
username_webhook = name_tool
avatar_webhook = 'https://media.discordapp.net/attachments/1394652767284363347/1399749288153841704/uruma_device_Logo.png?ex=688a219c&is=6888d01c&hm=3ccc78dff7d525afaee0726e44da2aec85b1d7817f3860facab7c0ea817fc62a&format=webp&quality=lossless&width=1032&height=1032'
...
def Reset():
    if os_name == "Windows":
        file = ['python', os.path.join(tool_path, "UrumaDEVICE.py")]
        subprocess.run(file)

    elif os_name == "Linux":
        file = ['python3', os.path.join(tool_path, "UrumaDEVICE.py")]
        subprocess.run(file)
